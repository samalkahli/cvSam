...
const DEFAULTS = {
  ar:{
    ...
    desc:'أطوع البرمجة والتقنية لخدمة الأعمال والتجارة الإلكترونية.',
    cta1:'تواصل معي ✦',cta2:'المشاريع والخبرات',
    scroll:'اسحب للأسفل',
    footer:'صُمّم بـ ✦ لـ سام اسكندر الكاهلي · جميع الحقوق محفوظة © 2026',
    aboutTitle:'من أنا؟',
    aboutP1:'أنا مطور تقني وشخص اجتماعي ومرح.',
    aboutP2:'بعيداً عن الأكواد، أوازن حياتي بالالتزام في النادي.',
    stats:[{n:'+3',l:'سنوات خبرة'}],
    pjTitle:'مشاريع مختارة',
    projects:[{title:'منصة Postertic',desc:'وصف المشروع',features:'ميزة 1\nميزة 2',link:'',images:[]}],
    expTitle:'المسيرة المهنية',
    experience:[{period:'الآن',role:'مطور',company:'شركة',points:['نقطة 1']}],
    skTitle:'الكفاءات',
    skills:[{n:'تطوير ويب',p:90,l:'Expert'}],
    eduTitle:'التعليم',
    education:[{ico:'🎓',deg:'جامعة',field:'تخصص',period:'2022',loc:'اليمن'}],
    ctTitle:'تواصل معي',
  ...
  en:{
    ...
    stats:[{n:'+3',l:'Years'}],
    pjTitle:'Projects',
    projects:[{title:'Postertic',desc:'Desc',features:'Feat 1',link:'',images:[]}],
    expTitle:'Experience',
    experience:[{period:'Now',role:'Dev',company:'Co',points:['Point 1']}],
    skTitle:'Skills',
    skills:[{n:'Web Dev',p:90,l:'Expert'}],
    eduTitle:'Education',
    education:[{ico:'🎓',deg:'Univ',field:'Major',period:'2022',loc:'Yemen'}],
    ctTitle:'Contact',
...
document.getElementById('btn-auto-translate').addEventListener('click', async () => {
    ...
    showToast('⏳ جاري ترجمة المحتوى... قد يستغرق الأمر ثواني معدودة');
    ...
    try {
        ...
        renderAdmin();
        showToast('✅ تمت الترجمة بنجاح! راجع النصوص ثم اضغط حفظ');
    } catch (err) {
